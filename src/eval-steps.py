...
FLAGS.add_argument('--dataset', type=str, choices=['MPC', 'SynthDisjoint',
...
def main():
    ...
    # ### Extend the loadpath to include the current task, since its already been trained prior to running this script
    # if args.modifier_list[args.task_num] == "None":
    #     task_modifier = ""
    # else:
    #     task_modifier = (args.modifier_list[args.task_num] + "_")
